...
export default function Home() {
  ...
  const prompt =
    additionalFeature === true
      ...
      : `${text} Make sure its not more than 2000 words`;
    ...
    <>
      <div className={`flex flex-col items-center m-0 `}>
        ...
        <div className="flex flex-col items-center pt-14 w-full px-4 md:px-0 max-w-screen-md">
          ...
          >
            Article Idea And Content Generator
          </h1>
          <form
            ...
            <AnimatePresence mode="wait">
              <motion.div className="space-y-4 my-5">
                {generatedTitles && (
                  ...
                  { additionalFeature ? <div className="max-w-screen-md grid gap-2 grid-cols-1  m-auto md:grid-cols-2">
                        ...
                        <div className="max-w-screen-md grid gap-2 grid-cols-1  m-auto md:grid-cols-1">
